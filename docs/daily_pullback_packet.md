...
## Source Status
- Positions: has_data from 2026-07-01 on $1,832,584.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| GOOGL | $100,000-$155,000 | $100,000-$155,000 | $50,000-$108,500 | $95,330 (5.2%) | 10.7%-13.7% | IVES $67,734, SMH $4,915, MAGS $381, GRNY $73,549 | Fidelity / Joint WROS - TOD *****2063 / taxable | GOOGL can still re-rate if the Fed reaction and AI tape turn green, but waiting avoids forcing a full add into mixed breadth, slightly higher yields, and unresolved source/flow checks. |
| MSFT | $25,000-$40,000 | $25,000-$40,000 | $12,500-$28,000 | $34,806 (1.9%) | 3.3%-4.1% | GRNY/IVES first | Fidelity / ROLLOVER IRA - RamBalusu *****6333 / traditional | MSFT can still re-rate if the Fed reaction and AI tape turn green, but waiting avoids forcing a full add into mixed breadth, slightly higher yields, and unresolved source/flow checks. |
...
| Ticker | Price | 52w high | Discount | Exposure | Sources | Disconfirmation |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| MSFT | $384 | $555 | -30.8% | $34,806 | mark l. newton, cmt B | Do not deploy if the laggard thesis remains only valuation-based without post-Fed live confirmation. |
| GOOGL | $361 | $409 | -11.6% | $95,330 | Fundstrat top-list, Notion Working WATCH, SEC 424B5 via manual off-hours alt-data scout 2026-06-09, fundstrat D, mark l. newton, cmt B, mark l. newton, cmt D, repo research queue Queued | Do not deploy if QQQ/SPY, yields, oil, source review, or flow contradict the staged add after the Fed reaction. |
| FN | $547 | $749 | -26.9% | $6,966 | Fundstrat top-list | Advance only if optical/AI infrastructure evidence and flow beat the base packet. |
| AVGO | $369 | $495 | -25.4% | $44,144 | Notion Working STAGE, repo research queue Queued, user update 2026-06-05: important AVGO date passed | Advance only if post-Fed semi tape and fresh flow beat GOOGL/MSFT on capital efficiency; prefer swap-funded review before net-new AI. |
| VRT | $311 | $380 | -18.0% | $12,779 | chart only | Advance only if power/cooling flow and entry quality beat the base packet. |
| NVDA | $198 | $237 | -16.5% | $241,954 | chart only | Already large; pullback is not enough unless target/sizing room and flow support it. |
| AMZN | $242 | $279 | -13.2% | $21,450 | chart only | Secondary add only if live source review is stronger than the funded GOOGL/MSFT packet. |

## Full Watchlist Screen
- Screened rows with chart data: 137.
