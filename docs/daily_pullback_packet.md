...
## Source Status
- Positions: has_data from 2026-06-17 on $1,911,969.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| GOOGL | $60,000-$110,000 | $100,000-$155,000 | $30,000-$77,000 | $71,812 (3.8%) | 6.9%-9.5% | IVES $68,091, SMH $2,019, MAGS $400, GRNY $82,448 | Schwab / Individual ...254 Individual ...25... / taxable | GOOGL can still re-rate if the Fed reaction and AI tape turn green, but waiting avoids forcing a full add into mixed breadth, slightly higher yields, and unresolved source/flow checks. |
| MSFT | $15,000-$30,000 | $25,000-$40,000 | $7,500-$21,000 | $29,281 (1.5%) | 2.3%-3.1% | GRNY $41,564 | Fidelity / Joint WROS - TOD *****2063 / taxable | MSFT can still re-rate if the Fed reaction and AI tape turn green, but waiting avoids forcing a full add into mixed breadth, slightly higher yields, and unresolved source/flow checks. |
...
| --- | ---: | ---: | ---: | ---: | --- | --- |
| BMNR | $16 | $161 | -90.2% | $70,851 | Notion Working MONITOR, repo research queue Queued | Do not add until financing impact, mNAV, ETH-per-share, preferred coverage, and crypto tape resolve. |
| LEU | $170 | $464 | -63.3% | $98,696 | chart only | Needs uranium/HALEU flow and policy confirmation; size is already meaningful. |
| AVAV | $167 | $418 | -60.0% | $0 | chart only | Deep pullback needs defense order, margin, and flow confirmation before capital competes with GOOGL/MSFT. |
...
| KTOS | $56 | $134 | -58.1% | $0 | Fundstrat bottom/avoid-list | Fundstrat bottom-list conflict means discount is research-only until source reconciliation changes. |
| SOFI | $17 | $33 | -46.8% | $886 | Fundstrat bottom/avoid-list | Fundstrat bottom-list conflict and small current exposure make this research-only. |
| UUUU | $15 | $28 | -45.2% | $34,549 | Fundstrat bottom/avoid-list | Critical-minerals pullback is not enough while Fundstrat source context remains avoid/bottom-list. |
| MP | $61 | $100 | -39.3% | $16,792 | chart only | Needs rare-earth policy/order-flow confirmation; discount alone is not a buy signal. |
| HOOD | $105 | $154 | -31.6% | $2,430 | Fundstrat bottom/avoid-list | Fundstrat bottom-list conflict; crypto/broker beta must confirm before any add review. |

## Higher Quality Pullbacks
| Ticker | Price | 52w high | Discount | Exposure | Sources | Disconfirmation |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| MSFT | $379 | $555 | -31.8% | $29,281 | chart only | Do not deploy if the laggard thesis remains only valuation-based without post-Fed live confirmation. |
| GOOGL | $364 | $409 | -11.0% | $71,812 | Fundstrat top-list, Notion Working WATCH, fundstrat D, repo research queue Queued | Do not deploy if QQQ/SPY, yields, oil, source review, or flow contradict the staged add after the Fed reaction. |
| FN | $584 | $749 | -22.0% | $7,741 | Fundstrat top-list | Advance only if optical/AI infrastructure evidence and flow beat the base packet. |
| AVGO | $393 | $495 | -20.6% | $40,277 | Notion Working STAGE, repo research queue Queued | Advance only if post-Fed semi tape and fresh flow beat GOOGL/MSFT on capital efficiency; prefer swap-funded review before net-new AI. |
| VRT | $318 | $380 | -16.4% | $0 | chart only | Advance only if power/cooling flow and entry quality beat the base packet. |
| AMZN | $238 | $279 | -14.7% | $21,562 | chart only | Secondary add only if live source review is stronger than the funded GOOGL/MSFT packet. |
| NVDA | $205 | $237 | -13.5% | $208,724 | chart only | Already large; pullback is not enough unless target/sizing room and flow support it. |

## Full Watchlist Screen
- Screened rows with chart data: 109.
