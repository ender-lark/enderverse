...
| OPS-RULES-2026-06-14 | Codex | Fold sprint-learned multi-agent and verification rules into repo-local operating protocol | `AGENTS.md`; `docs/WORKBOARD.md`; must not touch claimed rows/files `C2`, `C3`, `C4`, `C5`, `D`, `P2-4`, `T5`, `T6`, `T8`, `PARABOLIC-TRIGGER` | MERGED | 2026-06-14 |
