...
| T1 | Codex | Trigger registry and push spine for missed ASTS/MU/EWRE/tactical trigger class | `src/trigger_registry.json`; `src/trigger_check.py`; existing routine prompts/wrappers; dashboard warnings; receipts | IN-PROGRESS | 2026-06-12 20:35 ET |
