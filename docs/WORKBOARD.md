...
| REDDIT-SOCIAL | Codex | paused scheduled Social Watch; Chrome/manual snapshot-only Reddit scout path | `src/codex_routines/social_watch_intake.md`; Reddit/social docs; Codex automation config | PR#31 | 2026-06-16 ET |
| TRUMP-TRADE-WATCH | Codex | UW-backed Trump executive trade disclosure watch plus secondary Reddit scout group | `src/political_trade_watch.py`; `src/political_trade_watch.json`; `src/codex_routines/trump_trade_watch.md`; routine manifest/docs/tests; local automation config | PR#31 | 2026-06-20 ET |
| TRUMPSTRADES-SCOUT-2026-07-01 | Codex | Add `r/TrumpsTrades` to the Trump Trade Watch secondary Reddit scout and document current wiring gaps | `src/reddit_collector.py`; `src/test_reddit_collector.py`; `src/codex_routines/trump_trade_watch.md`; Reddit docs; local automation config | PR#31 | 2026-07-01 |
