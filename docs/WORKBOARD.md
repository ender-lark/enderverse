...
| R1 | Claude Code | Research backlog triage: kill/uncertain/relevant split vs repo truth (positions/theses/triggers) | `docs/research_dossiers/TRIAGE_2026-06-13.md` | IN-PROGRESS | 2026-06-13 00:45 ET |
| R2 | Claude Code | Research feed fix (`--from-notion` intake) + ghost-routine audit/guard for off-hours-research-queue & top-prospects-auto-research | `src/research_queue_intake.py`; `src/test_research_queue_intake.py`; new overdue-guard test; `src/codex_routines/off_hours_research.md` | IN-PROGRESS | 2026-06-13 00:45 ET |
| R3 | Claude Code | Full research burn: evidence dossiers for every RELEVANT row + research block + INDEX | `docs/research_dossiers/*_2026-06-13.md`; `docs/research_dossiers/INDEX.md`; `src/research_queue.json` (research block only) | IN-PROGRESS | 2026-06-13 00:45 ET |
| R4 | Claude Code | Make tonight repeatable: 7:30 PM ET weekday delta-triage routine prompt + stamp-refresh + receipt | `src/codex_routines/off_hours_research.md` | IN-PROGRESS | 2026-06-13 00:45 ET |
