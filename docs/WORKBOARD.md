...
| REDDIT-SOCIAL | Codex | staged Reddit scout v2: source health plus narrative pattern reports | `src/reddit_collector.py`; `src/test_reddit_collector.py`; Reddit/social docs; tmp-only reports | PR#31 | 2026-06-16 ET |
