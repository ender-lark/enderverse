...
| T8 | Codex | Account semantics absorb for executable tax_status and account flags | `src/account_rules.json`; SnapTrade profile/semantics path; execution-plan placement tests | IN-PROGRESS | 2026-06-14 15:38 ET |
