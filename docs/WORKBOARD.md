...
| MERGE-AUTH | Codex | Codex merge authority policy: operator-explicit only, green/accepted checks only, no bypassing conflicts or protection | `AGENTS.md`; `docs/WORKBOARD.md` | IN-PROGRESS | 2026-06-13 18:13 ET |
