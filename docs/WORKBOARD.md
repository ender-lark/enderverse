...
| C2 | Codex | Gate semantics: close/touch/near-certain with 6/11 QQQ trap test | `src/timing_gates.json`; `src/timing_engine.py`; related tests | PR#30 | 2026-06-14 15:59 ET |
