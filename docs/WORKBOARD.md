...
| EFFICACY-HARNESS | Claude Code | regression proof the trigger spine + sizing block catch the documented misses | `src/test_efficacy_harness.py`; `src/efficacy_scenarios.json`; `docs/efficacy_gaps.md` (new files only) | PR#22 | 2026-06-13 |
