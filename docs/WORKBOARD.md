...
| T3 | Codex | Integration-debt sweep and Sunday Weekly Pilot Run hook | `src/integration_debt_sweep.py`; `docs/integration_debt_report.md`; weekly pilot prompt; dashboard warning count | IN-PROGRESS | 2026-06-13 00:45 ET |
