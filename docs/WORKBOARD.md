...
| C4 | Codex | Bible tactical extension: tactical top/bottom and named levels; full-text monthly checklist | `src/fundstrat_bible.json`; `src/fundstrat_sector_stances.py`; FundStrat intake docs/tests | PR#32 | 2026-06-14 16:09 ET |
