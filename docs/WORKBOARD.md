...
| T9 | Codex | Held-decisions strip for operator-parked decision packets with review-by triggers | `src/held_decisions.json`; `src/held_decisions.py`; `src/test_held_decisions.py`; `src/cockpit_html_gen.py`; `src/trigger_registry.json`; `docs/codex_tasks/held_decisions_strip.md` | PR#19 | 2026-06-12 22:13 ET |
