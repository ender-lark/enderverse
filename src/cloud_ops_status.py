...
DEFAULT_EXPECTED_AUTOMATIONS = [
    ...
    },
    {
        ...
        "schedule": "daily 9:15 PM ET",
        "days": [0, 1, 2, 3, 4, 5, 6],
        "hour": 21,
        "minute": 15,
        "expected_since": "2026-06-09T00:00:00-04:00",
    },
    {
        "automation_id": "investing-os-loose-thread-sweep",
        "automation_name": "Investing OS Loose-Thread Sweep",
        "role": "loose_thread_sweep",
