...
def _self_test() -> bool:
    ...
    manifest = {
        ...
        "routines": [
            ...
            {**routine, "id": "social_watch_intake", "doc": "src/codex_routines/social_watch_intake.md", "owns": ["src/social_watch.json"]},
            {**routine, "id": "trump_trade_watch", "doc": "src/codex_routines/trump_trade_watch.md", "owns": ["src/political_trade_watch.json"]},
