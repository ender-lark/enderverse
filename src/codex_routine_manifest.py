...
def _self_test() -> bool:
    ...
    manifest = {
        ...
        "routines": [
            ...
            {**routine, "id": "options_chain_refresh", "doc": "src/codex_routines/options_chain_refresh.md", "separation_group": "market_data_refresh", "owns": ["src/options_chain_cache.json"]},
            {**routine, "id": "options_decay_audit", "doc": "src/codex_routines/options_decay_audit.md", "separation_group": "market_data_refresh", "owns": ["src/options_decay_audit.json"]},
            ...
            {**routine, "id": "federal_funding_moves", "doc": "src/codex_routines/Federal_Funding_Moves_Routine_Prompt_v1.md", "owns": ["src/federal_funding_moves.json"]},
            ...
            {**routine, "id": "dossier_keeper", "doc": "src/codex_routines/dossier_keeper.md", "separation_group": "dossier_maintenance", "owns": ["docs/research_dossiers/"]},
