...
def test_todaydecide_jsx_consumes_canonical_payload_fields():
    ...
    for path in (
        ...
        "payload.disposition_pressure", "payload.candidate_feed_index", "payload.disposition_coverage", "payload.data_health", "payload.cards", "payload.backlog", "payload.congruence",
        "payload.honesty",
    ):
