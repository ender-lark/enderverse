...
EXTERNAL_LANES = {
    ...
    "social_watch": "Social Watch",
    "political_trade_watch": "Trump Trade Watch",
...
LANE_NEXT_STEPS = {
    ...
    "social_watch": "Supply social_watch.json from the compliant Reddit/social API intake before treating social anomalies as checked.",
    "political_trade_watch": "Supply political_trade_watch.json from the UW political-disclosure intake before treating Trump disclosures as checked.",
...
LANE_MISSING_IMPACT = {
    ...
    "social_watch": "Reddit/social early-signal anomalies are not checked; absence is not no social signal.",
    "political_trade_watch": "Trump/executive trade disclosures are not checked; absence is not no disclosure flow.",
