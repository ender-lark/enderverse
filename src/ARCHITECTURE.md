...
* Dossier alert/watch wiring must be sequenced as a follow-up that consumes merged staleness guard PR#57, so alert surfaces and dossier cards share one freshness policy.
